...
public static class MauiProgram
{
    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        var signalRHubUrl = "https://d45d-145-14-21-133.ngrok-free.app/chatHub";
    ...
    new AuthService("https://d45d-145-14-21-133.ngrok-free.app/authHub"));
        ...
        builder.Services.AddSingleton<DeviceService>(provider => new DeviceService(provider.GetRequiredService<Supabase.Client>(), provider.GetRequiredService<AuthService>()));
